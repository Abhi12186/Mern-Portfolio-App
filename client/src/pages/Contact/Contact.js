            ...
            <div className='row'>
                ...
                <div className='col-lg-6 col-md-6'>
                    <div className='card2 d-flex card border-0 px-4 py-5'>
                        ...
                        <div className='row'>
                           <h6>Contact with
                            <a href="https://www.linkedin.com/in/abhishek-pathak-476338269/" target="_blank" rel="noopener noreferrer">
                           <BsLinkedin color="blue" size={30} className="ms-2" />
                            </a>

                            <a href="https://github.com/Abhi12186" target="_blank" rel="noopener noreferrer">
